...
{
    protected $config = ['source' => 0, 'visible' => true, 'limit' => null, 'airline' => null, 'location' => null, 'company' => null, 'popups' => null,'uid' => 0];
    ...
    public function run()
    {
        ...
        if ($type != 'fleet' && $type != 'aerodromes') {
            ...
            foreach ($mapflights as $mf) {
                ...
                $citypairs[] = array(
                    ...
                    'deplat' => $mf->dpt_airport->lat,
                    'deplon' => $mf->dpt_airport->lon,
                    'arrlat' => $mf->arr_airport->lat,
                    'arrlon' => $mf->arr_airport->lon,
                );
            }
        ...
        $GreenUrl = 'https://aeroviavirtual.com.br/wp-content/uploads/2022/12/point-hub.png';
        $BlueUrl = 'https://aeroviavirtual.com.br/wp-content/uploads/2022/12/point-normal.png';
        ...
        if (isset($citypairs)) {
            foreach ($citypairs as $citypair) {
                ...
                $mapCityPairs[] = [
                    ...
                    'lmdeplat' => $citypair['deplat'],
                    'lmdeplon' => $citypair['deplon'],
                    'lmarrlat' => $citypair['arrlat'],
                    'lmarrlon' => $citypair['arrlon'],
                    'geoc' => $cp_color,
                    'pop'  => $popuptext,
                ];
            }
